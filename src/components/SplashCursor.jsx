...
// Adapted from React Bits SplashCursor. See SplashCursor.LICENSE.md.
function SplashCursor({
  ...
  useEffect(() => {
    ...
    let config = {
      SIM_RESOLUTION: isMobile ? Math.min(SIM_RESOLUTION, 96) : SIM_RESOLUTION,
      DYE_RESOLUTION: isMobile ? Math.min(DYE_RESOLUTION, 512) : DYE_RESOLUTION,
      CAPTURE_RESOLUTION,
      DENSITY_DISSIPATION,
      VELOCITY_DISSIPATION,
      PRESSURE,
      PRESSURE_ITERATIONS: isMobile ? Math.min(PRESSURE_ITERATIONS, 14) : PRESSURE_ITERATIONS,
      CURL,
      SPLAT_RADIUS,
      SPLAT_FORCE,
      SHADING,
